defmodule RecipebookWeb.RecipeControllerTest do
  ...
  describe "index/2" do
    ...
    test "Responds with all recipes", %{conn: conn, recipe: recipe} do
      ...
      expected = %{
        "data" => [
          %{"min_servings" => recipe.min_servings, "max_servings" => recipe.max_servings, "title" => recipe.title}
        ]
      }
  ...
  describe "show/2" do
    ...
    test "Responds with recipe info if the recipe is found", %{conn: conn, recipe: recipe} do
      ...
      response =
        ...
        expected = %{"data" => %{"min_servings" => recipe.min_servings, "max_servings" => recipe.max_servings, "title" => recipe.title}}
